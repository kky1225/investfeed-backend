...
class SecondaryAuthFilter(
    ...
    private val protectedPaths = listOf("/api/auth/admin/", "/api/admin/", "/api/stock/holding/", "/api/crypto/holding/", "/api/asset/", "/api/stock/realizedpnl/", "/api/crypto/realizedpnl/", "/api/realizedpnl/")
