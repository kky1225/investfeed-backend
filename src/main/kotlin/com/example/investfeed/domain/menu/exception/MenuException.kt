...
class InvalidBrokerForMenuException(message: String) : InvestFeedException(code = "MENU_4012", message = message)
class MenuCycleException : InvestFeedException(code = "MENU_4013", message = "메뉴를 자기 자신 또는 하위 메뉴의 하위로 이동할 수 없습니다.")
