package com.example.investfeed.kiwoom.chart.dto.res

data class ChartMinuteList(
    ...
    var upd_stkpc_tp: String? = null, // 수정주가구분 1:유상증자, 2:무상증자, 4:배당락, 8:액면분할, 16:액면병합, 32:기업합병, 64:감자, 256:권리락
